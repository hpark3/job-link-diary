  ...
  return (
    <div className="grid grid-cols-3 gap-4">
      <div className="bg-secondary rounded-xl p-4">
        <div className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Days Tracked</div>
        <div className="stat-value">{allDates.length}</div>
      </div>
      <div className="bg-secondary rounded-xl p-4">
        <div className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Roles</div>
        <div className="stat-value">{uniqueRoles}</div>
      </div>
      <div className="bg-secondary rounded-xl p-4">
        <div className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Regions</div>
