  ...
  return (
    <section className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-sm text-muted-foreground uppercase tracking-wider">API Access</h2>
      </div>

      <div className="rounded-lg border border-border bg-card p-5 space-y-5 text-sm">
        {/* Disclaimer */}
